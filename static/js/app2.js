...
function plot(names) {
    ...
    $.each(names, function (i, name) {
        $.getJSON('https://www.quandl.com/api/v3/datasets/WIKI/' + name + '.json?start_date=2016-10-01&end_date=2017-10-02&api_key=v9T6M6UHaZsb_Py6AxE9',
            function (data) {

                var result = [],
                    result_data = data.dataset.data;
                j = 0;
                for (j; j < result_data.length; j += 1) {
